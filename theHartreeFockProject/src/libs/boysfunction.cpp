...
BoysFunction::BoysFunction(int angMomMax){
    ...
    string filename;
    filename = "boys_tabulated.dat"; // /home/goranbs/goran/CompPhys/FYS4411 - CompPhys2/build-theHartreeFockProject-Desktop-Debug/src/HartreeFock/boys_tabulated.dat";
//    ifstream myfile;
